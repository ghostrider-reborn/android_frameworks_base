...
public class AudioService extends IAudioService.Stub
    ...
    */
    ...
    public AudioService(Context context, AudioSystemAdapter audioSystem,
        ...
        mNotifAliasRing = Settings.Secure.getInt(mContext.getContentResolver(),
    ...
    private void readPersistedSettings() {
        ...
        mNotifAliasRing = Settings.Secure.getInt(cr,
                Settings.Secure.VOLUME_LINK_NOTIFICATION, 0) == 1;
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            synchronized (mSettingsLock) {
                ...
                boolean notifAliasRing = Settings.Secure.getInt(mContentResolver,
                        Settings.Secure.VOLUME_LINK_NOTIFICATION, 0) == 1;
                if (notifAliasRing != mNotifAliasRing) {
